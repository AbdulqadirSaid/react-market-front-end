...
const GenerateReport = () => {
  ...
  const handleGenerateReport = (e) => {
    ...
    if (
      reportType === "market_sales" ||
      reportType === "market_owner_performance" ||
      reportType === "product_listings"
    ) {
    ...
    alert(
      `Report of type "${reportType}" generated successfully for the selected period.`
    );
          ...
          <div className="container-fluid mt-4">
            <div className="card shadow-lg p-4 bg-white border-0 rounded-4">
              <h2 className="mb-4 text-primary fw-bold">
                <i className="bi bi-file-earmark-bar-graph me-3"></i>Generate
                Reports
              </h2>
              <p className="mb-4 text-muted lead">
                Select report type, date range, and apply filters to generate
                various system reports. These reports provide insights into
                customer activity, market performance, and more.
              </p>
              ...
              <div className="card shadow-lg p-4 bg-white rounded-3">
                <form onSubmit={handleGenerateReport}>
                    ...
                    <div className="col-md-6">
                      ...
                      >
                        ...
                        <optgroup label="Customer Reports">
                          <option value="customer_registration">
                        ...
                        <optgroup label="Market Reports">
                          <option value="market_sales">
                            Market Sales Performance
                          </option>
                          <option value="market_owner_performance">
                            Market Owner Performance
                          </option>
                          <option value="product_listings">
                        ...
                        <optgroup label="Financial Reports">
                          <option value="revenue_summary">
                            Revenue Summary
                          </option>
                          <option value="payments_processed">
                            Payments Processed
                          </option>
                        </optgroup>
                      </select>
                  ...
                  {(reportType === "market_sales" ||
                    ...
                    <div className="row mb-4">
                      <div className="col-md-6">
                        <label htmlFor="selectedMarket" className="form-label">
                          Select Market
                        </label>
                        <select
                          id="selectedMarket"
                ...
                <div className="text-center py-5 bg-light rounded-3">
                  ...
                  <p className="lead text-muted">
                    Your generated report data will appear here.
                  </p>
                  <small className="text-secondary">
                    Select options above and click "Generate Report".
                  </small>
