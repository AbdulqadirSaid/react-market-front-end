...
const Dashboard = () => {
  ...
  const recentActivities = [
    {
      id: 1,
      text: 'Vendor "Fresh Fruits Jumbi" updated product stock.',
      time: "5 minutes ago",
      type: "success",
    },
    {
      id: 2,
      text: "New customer registered from Mwanakwerekwe.",
      time: "1 hour ago",
      type: "info",
    },
    {
      id: 3,
      text: "Order #MZ2025-0012 (Mwanakwerekwe) processed.",
      time: "3 hours ago",
      type: "primary",
    },
    {
      id: 4,
      text: 'Product "Seaweed 1kg" (Jumbi) stock low.',
      time: "Yesterday",
      type: "warning",
    },
    {
      id: 5,
      text: 'Market Owner "Binti Kiziwi" account reviewed.',
      time: "2 days ago",
      type: "secondary",
    },
    {
      id: 6,
      text: "New vendor registration pending approval in Jumbi.",
      time: "3 days ago",
      type: "danger",
    },
  ];
        ...
        <main className="flex-grow-1 p-4 overflow-auto">
          ...
          <div className="container-fluid">
            <h1 className="mb-4 display-4 text-primary fw-bold">
              <i className="bi bi-shop-window me-3"></i>Zanzibar e-Market
              Central Dashboard
            </h1>
            <p className="lead text-muted mb-5">
              Real-time insights and operational overview for **Jumbi and
              Mwanakwerekwe Markets**.
            </p>
                ...
                <div className="card bg-gradient-success text-white p-3 shadow-lg border-0 rounded-4 h-100 animate__animated animate__fadeInUp">
                  <div className="card-body">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <h5 className="card-title mb-0 opacity-75">
                          Total Active Vendors
                        </h5>
                        <p className="card-text fs-2 fw-bold">{totalVendors}</p>
                        <small>
                          Jumbi: {activeVendorsJumbi} | Mwanakwerekwe:{" "}
                          {activeVendorsMwanakwerekwe}
                        </small>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <small>
                          Jumbi: {productsJumbi} | Mwanakwerekwe:{" "}
                          {productsMwanakwerekwe}
                        </small>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <small>
                          Jumbi: {pendingOrdersJumbi} | Mwanakwerekwe:{" "}
                          {pendingOrdersMwanakwerekwe}
                        </small>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <small>
                          Jumbi: {jumbiRevenueThisMonth} | Mwanakwerekwe:{" "}
                          {mwanakwerekweRevenueThisMonth}
                        </small>
                      </div>
                    </div>
                  </div>
              ...
              <div className="col-lg-6 col-md-12">
                <div className="card shadow-lg p-4 bg-white rounded-4 h-100 animate__animated animate__fadeInUp animate__delay-5s">
                  <h4 className="mb-4 text-secondary">
                    <i className="bi bi-activity me-2"></i>Overall Market
                    Activity Trend
                  </h4>
                  <div className="text-center py-5 border rounded bg-light">
                    <p className="text-muted">
                      <i className="bi bi-graph-up-arrow display-6 text-warning"></i>
                      <br /> Combined Market Activity Chart (e.g., daily
                      transactions, user engagement).
                      <br /> (This chart would integrate data from both Jumbi
                      and Mwanakwerekwe)
                    </p>
                  </div>
                </div>
            ...
            <section className="row mb-5 g-4">
              <div className="col-lg-6">
                <div className="card shadow-lg p-4 bg-white rounded-4 h-100 animate__animated animate__fadeInLeft">
                  <h4 className="mb-4 text-secondary">
                    <i className="bi bi-graph-up-arrow me-2"></i>Jumbi Market
                    Performance
                  </h4>
                  <div className="text-center py-5 border rounded bg-light">
                    <p className="text-muted">
                      <i className="bi bi-bar-chart-fill display-6 text-primary"></i>
                      <br /> **Jumbi Market** Sales & Product Trends Chart will
                      be displayed here.
              ...
              <div className="col-lg-6">
                <div className="card shadow-lg p-4 bg-white rounded-4 h-100 animate__animated animate__fadeInRight">
                  <h4 className="mb-4 text-secondary">
                    <i className="bi bi-bar-chart-line me-2"></i>Mwanakwerekwe
                    Market Performance
                  </h4>
                  <div className="text-center py-5 border rounded bg-light">
                    <p className="text-muted">
                      <i className="bi bi-pie-chart-fill display-6 text-success"></i>
                      <br /> **Mwanakwerekwe Market** Sales & Product Categories
                    ...
                    >
                      ...
                      <li>
                        **Monthly Revenue:** {mwanakwerekweRevenueThisMonth}
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <section className="mb-5 animate__animated animate__fadeInUp">
              <h2 className="mb-4 text-primary">
                <i className="bi bi-clock-history me-2"></i>Recent System
                Activity Log
              </h2>
                ...
                <div className="card-body">
                  ...
                  <ul className="list-group list-group-flush">
                    {recentActivities.map((activity) => (
                      ...
                      >
                        <i
                          className={`bi bi-arrow-right-short text-${activity.type} me-2`}
                        ></i>{" "}
                        {activity.text}
                  ...
                  <button className="btn btn-outline-primary mt-4 btn-sm">
                    <i className="bi bi-list-nested me-2"></i>View Comprehensive
                    Log
                  </button>
                </div>
              </div>
            ...
            <section className="mb-5 animate__animated animate__fadeInUp">
              <h2 className="mb-4 text-primary">
                <i className="bi bi-tools me-2"></i>Quick Administrative Actions
              </h2>
              <div className="row g-3">
                ...
                <div className="col-md-4 col-sm-12">
                  <button className="btn btn-lg btn-block btn-secondary w-100 shadow-sm rounded-3 py-3">
                    <i className="bi bi-database-gear me-2"></i>System Data
                    Management
                  </button>
                </div>
              </div>
