...
const ManageReports = () => {
  ...
  // --- Wrap generateReport in useCallback ---
  ...
  }, [reportType, marketFilter, dateRange]); // <-- Dependencies for useCallback: these are the state variables generateReport uses.

  // --- Update useEffect dependency array ---
  useEffect(() => {
    generateReport();
  }, [generateReport]); // <-- Now useEffect only depends on the memoized generateReport function.

  return (
    <div className="container-fluid mt-4">
      <div className="card shadow-lg p-4 bg-white">
        <h3 className="mb-4 text-primary"><i className="bi bi-clipboard-data me-2"></i>Manage Reports</h3>
        ...
        {!loading && !error && reportData && (
          <div className="report-display mt-4">
           ...
           {reportType === 'revenue' && reportData.data && (
              <div className="row justify-content-center"> {/* <-- CORRECTED LINE */}
                <div className="col-lg-10">
                  <div className="card shadow-sm mb-4">
