        ...
        <main className="flex-grow-1 overflow-auto p-4" style={{ backgroundColor: "#f8f9fa" }}>
          <div className="container-fluid mt-4">
            <div className="card shadow-lg p-4 bg-white border-0 rounded-4">
              ...
              {!loading && !error && (
                <>
                  {/* Revenue Summary Cards - Adjusted font sizes */}
                    ...
                    <div className="col-md-6 col-lg-3 d-flex">
                      <div className="card text-center text-white bg-gradient-success flex-fill shadow-lg border-0 rounded-3 animate__animated animate__fadeInUp">
                        <div className="card-body p-4">
                          <i className="bi bi-graph-up-arrow fs-3 mb-2"></i> {/* Reduced icon size */}
                          {/* Changed text color to black */}
                          <h5 className="card-title text-black">Total Revenue</h5> 
                          {/* Reduced font size for amount */}
                          <p className="card-text fs-4 fw-bold text-black">{formatTsh(revenueSummary.totalRevenue)}</p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6 col-lg-3 d-flex">
                      <div className="card text-center text-white bg-gradient-primary flex-fill shadow-lg border-0 rounded-3 animate__animated animate__fadeInUp animate__delay-1s">
                        <div className="card-body p-4">
                          <i className="bi bi-cash-stack fs-3 mb-2"></i> {/* Reduced icon size */}
                          {/* Changed text color to black */}
                          <h5 className="card-title text-black">Total Payouts</h5>
                          {/* Reduced font size for amount */}
                          <p className="card-text fs-4 fw-bold text-black">{formatTsh(revenueSummary.totalPayouts)}</p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6 col-lg-3 d-flex">
                      <div className="card text-center text-white bg-gradient-info flex-fill shadow-lg border-0 rounded-3 animate__animated animate__fadeInUp animate__delay-2s">
                        <div className="card-body p-4">
                          <i className="bi bi-wallet2 fs-3 mb-2"></i> {/* Reduced icon size */}
                          {/* Changed text color to black */}
                          <h5 className="card-title text-black">Current Balance</h5>
                          {/* Reduced font size for amount */}
                          <p className="card-text fs-4 fw-bold text-black">{formatTsh(revenueSummary.balance)}</p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6 col-lg-3 d-flex">
                      <div className="card text-center text-dark bg-gradient-warning flex-fill shadow-lg border-0 rounded-3 animate__animated animate__fadeInUp animate__delay-3s">
                        <div className="card-body p-4">
                          <i className="bi bi-hourglass fs-3 mb-2"></i> {/* Reduced icon size */}
                          <h5 className="card-title text-opacity-75">Pending Payouts</h5>
                          {/* Reduced font size for amount */}
                          <p className="card-text fs-4 fw-bold">{formatTsh(revenueSummary.pendingPayouts)}</p>
                        </div>
                      </div>
                    </div>
                  </div>
