    ...
    <div className="d-flex flex-column min-vh-100" style={{ backgroundColor: "#f5f7fa" }}>
      ...
      <div className="d-flex flex-grow-1">
        ...
        <main className="flex-grow-1 overflow-auto p-4" style={{ backgroundColor: "#f8f9fa" }}>
          {/* Using Bootstrap Container and Row for reduced content width */}
          <div className="container-fluid"> {/* Use 'container' if you want a fixed max-width, 'container-fluid' for full width with padding */}
            <div className="row justify-content-center">
              <div className="col-12 col-xxl-10 col-xl-11 col-lg-12"> {/* Adjust these column sizes for desired width */}
