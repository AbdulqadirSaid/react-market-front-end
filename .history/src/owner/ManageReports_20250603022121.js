...
const ManageReports = () => { // Changed component name to ManageReports
  ...
  const generateReport = async () => {
    ...
    try {
      ...
      if (reportType === 'summary') {
        ...
        data = {
            // Example data for a simple line chart (Occupied vs Available - Line used due to prior ChartJS register for Line)
            labels: ['Occupied Stalls', 'Available Stalls'],
            datasets: [
                {
                    data: [120, 30], // Example: 120 occupied, 30 available
                    backgroundColor: ['#17a2b8', '#6c757d'],
                    borderColor: ['#17a2b8', '#6c757d'],
  ...
  return (
    <div className="container-fluid mt-4">
      <div className="card shadow-lg p-4 bg-white">
        <h3 className="mb-4 text-primary"><i className="bi bi-bar-chart-line me-2"></i>Manage Reports</h3>
                  ...
                  <div className="card shadow-sm">
                    ...
                    <div className="card-body text-center">
                        <div style={{ maxWidth: '400px', margin: '0 auto' }}>
                           <Line data={reportData.data} options={{ // Changed from Doughnut to Line as Doughnut was not registered
                            responsive: true,
                            maintainAspectRatio: true,
                            plugins: { legend: { position: 'top' }, title: { display: false } }
                            }} />
