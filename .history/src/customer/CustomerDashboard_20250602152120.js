...
import jumbiMarketImg from "../images/Jumbi-Image.jpg"; // Path to Jumbi image
import mwanakwerekweMarketImg from "../images/Kwere_Image.jpg"; // Path to Mwanakwerekwe image
    ...
    <div className="d-flex flex-column min-vh-100">
      ...
      <div className="d-flex flex-grow-1">
        ...
        <main className="flex-grow-1" style={{ backgroundColor: "#f8f9fa" }}>
          ...
          <section
            className="py-4 text-center text-white bg-primary position-relative overflow-hidden"
            style={{
              backgroundImage:
                'url("https://via.placeholder.com/1500x400/563d7c/ffffff?text=Zanzibar+Market+Vibes")', // Keeping this as a generic background
          ...
          >
            <div className="container px-3">
              ...
              >
                Dive into the vibrant tapestry of Jumbi and Mwanakwerekwe.
                Discover unparalleled freshness, rich culture, and endless
                opportunities.
              </p>
              <NavLink
                to="/browse-market"
            ...
            <div className="container">
              <div className="row align-items-center">
                <div className="col-lg-6 mb-3 mb-lg-0 animate__animated animate__fadeInLeft">
                  <img
                    src={jumbiMarketImg} // <-- Using the imported Jumbi image
                ...
                <div className="col-lg-6 animate__animated animate__fadeInRight">
                  <h3 className="h3 fw-bold text-success mb-2">
                    Jumbi: Where Freshness Comes Alive!
                  </h3>
                  <p className="fs-6 text-muted mb-3">
                    Experience the true essence of local farming at Jumbi
                    Market. Here, every stall bursts with **organic produce**,
                    hand-picked fruits, and artisanal goods, creating a sensory
                    feast for every visitor.
                  </p>
                  <ul className="list-unstyled fa-ul mb-3 small">
                    <li>
                      ...
                      **Peak Season Produce:** Direct from farm to your table,
                    ...
                    <li>
                      ...
                      **Unique Local Delicacies:** Discover flavors you won't
                      find anywhere else.
                    </li>
                    <li>
                      <span className="fa-li">
                      ...
                      **Support Local Farmers:** Every purchase directly
            ...
            <div className="container">
              <div className="row align-items-center flex-md-row-reverse">
                <div className="col-lg-6 mb-3 mb-lg-0 animate__animated animate__fadeInRight">
                  <img
                    src={mwanakwerekweMarketImg} // <-- Using the imported Mwanakwerekwe image
                    className="img-fluid rounded shadow-lg transform-on-hover"
                ...
                <div className="col-lg-6 animate__animated animate__fadeInLeft">
                  <h3 className="h3 fw-bold text-info mb-2">
                    Mwanakwerekwe: A Kaleidoscope of Island Life!
                  </h3>
                  <p className="fs-6 text-muted mb-3">
                    Zanzibar's largest market is an immersion into the island's
                    soul. Explore aromatic **spice stalls**, vibrant textiles,
                    and a dynamic atmosphere where every corner tells a story.
                  </p>
                  <ul className="list-unstyled fa-ul mb-3 small">
                    <li>
                      <span className="fa-li">
                      ...
                      **World-Renowned Spices:** From cloves to vanilla, the
                      scents of Zanzibar.
                    </li>
                    <li>
                      <span className="fa-li">
                      ...
                      **Handwoven Textiles:** Discover unique kanga and
                      traditional fabrics.
                    </li>
                    <li>
                      <span className="fa-li">
                      ...
                      **Lively Bazaars:** A true cultural melting pot for unique
                      finds.
                    </li>
                  </ul>
                  <NavLink
                  ...
                  >
                    Discover Mwanakwerekwe's Magic{" "}
                    <i className="bi bi-tags-fill ms-2"></i>
                  </NavLink>
                </div>
              </div>
            </div>
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-md-4 mb-3">
                  <div
                    className="p-3 bg-secondary rounded shadow-sm h-100 d-flex flex-column justify-content-center animate__animated animate__pulse animate__infinite"
                  ...
                  >
                    ...
                    <p className="small mb-0">
                      Easy online reservations for your perfect spot.
                    </p>
                  </div>
                </div>
                <div className="col-md-4 mb-3">
                  ...
                  >
                    ...
                    <p className="small mb-0">
                      From fresh produce to unique crafts, find it all!
                    </p>
                  </div>
                </div>
                <div className="col-md-4 mb-3">
