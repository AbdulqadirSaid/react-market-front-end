...
const OwnerDashboard = () => { // Renamed Dashboard to OwnerDashboard for clarity and consistency
    ...
    <div className="d-flex flex-column min-vh-100">
      ...
      <div className="d-flex flex-grow-1">
        ...
        <main className="flex-grow-1" style={{ backgroundColor: "#f8f9fa" }}>
          {/* Hero Section: Main Welcome for Market Owners - Removed black color */}
          <section
            // Changed bg-dark to bg-primary (Bootstrap blue)
            className="py-3 text-center text-white bg-primary position-relative overflow-hidden"
            style={{
              // Changed placeholder image to a blue background
              backgroundImage:
                'url("https://via.placeholder.com/1500x300/007bff/ffffff?text=Your+Marketplace+Hub")', // Bootstrap primary blue
              ...
              // Changed rgba(0,0,0,0.5) (black overlay) to rgba(0, 123, 255, 0.4) (blue overlay)
              boxShadow: "inset 0 0 0 2000px rgba(0, 123, 255, 0.4)", // Blue overlay (Bootstrap primary blue)
            }}
          >
          ...
          <section className="py-3 bg-white">
            <div className="container">
              ...
              <div className="row g-3 justify-content-center">
                ...
                {/* Corrected path from /owner-dash/generate-reports to /owner-dash/manage-reports */}
          ...
          <section className="py-3 bg-light text-center">
            <div className="container">
              {/* Changed text-dark to text-secondary for softer look */}
