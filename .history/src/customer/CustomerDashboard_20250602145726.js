    ...
    <div className="d-flex flex-column min-vh-100">
      ...
      <div className="d-flex flex-grow-1">
        ...
        <main className="flex-grow-1" style={{ backgroundColor: '#f8f9fa' }}>
          ...
          {/* Hero Section: Main Welcome - Remains full width for visual impact */}
          <section className="py-5 text-center text-white bg-primary position-relative overflow-hidden"
            style={{
              backgroundImage: 'url("https://via.placeholder.com/1500x500/563d7c/ffffff?text=Zanzibar+Market+Vibes")', // Replace with actual image
            ...
            {/* The content inside the hero can be within a container for text width control */}
          ...
          {/* Jumbi Market Showcase - Now inside a container */}
          <section className="py-5 bg-white" style={{ padding: '4rem 0' }}>
            <div className="container"> {/* Added container here */}
              <div className="row align-items-center">
                <div className="col-lg-6 mb-4 mb-lg-0 animate__animated animate__fadeInLeft">
                  <img src="https://via.placeholder.com/800x600/FF8C00/FFFFFF?text=Jumbi+Market+Abundance" // Replace with actual image
          ...
          {/* Mwanakwerekwe Market Showcase - Now inside a container */}
          <section className="py-5 bg-light" style={{ padding: '4rem 0' }}>
            <div className="container"> {/* Added container here */}
              <div className="row align-items-center flex-md-row-reverse">
                <div className="col-lg-6 mb-4 mb-lg-0 animate__animated animate__fadeInRight">
                  <img src="https://via.placeholder.com/800x600/007BFF/FFFFFF?text=Mwanakwerekwe+Market+Culture" // Replace with actual image
                    className="img-fluid rounded shadow-lg transform-on-hover"
          ...
          {/* Interactive Feature: Quick Stats or Testimonials - Now inside a container */}
