        ...
        <main className="flex-grow-1 overflow-auto p-3" style={{ backgroundColor: "#f8f9fa" }}>
          <div className="container-fluid mt-4">
            <div className="card shadow-lg p-4 bg-white border-0 rounded-4">
              <h2 className="mb-4 text-primary fw-bold"><i className="bi bi-people-fill me-3"></i>Manage Customers</h2>
              <p className="mb-4 text-muted lead">View, search, and manage all customer accounts registered in the system. You can update their profiles or change their access status.</p>
