...
// Kama picha zako ziko ndani ya 'src/assets/' au 'src/images/', hakikisha path ni sahihi.
// Mfano: import JumbiImage from '../assets/Jumbi-Image.jpg';
// Kama ziko kwenye 'public' folder, futa hizi imports na tumia '/Jumbi-Image.jpg' moja kwa moja.
// ***************************************************************
import JumbiImage from '../images/Jumbi-Image.jpg'; // Badilisha path kama inavyohitajika
import KwereImage from '..//images/Kwere_Image.jpg'; // Badilisha path kama inavyohitajika

const markets = [
  {
    id: 1,
    title: 'Jumbi Market',
    image: JumbiImage, // Inatumia picha ya Jumbi
  },
  {
    id: 2,
    title: 'Mwanakwerekwe Market',
    image: KwereImage, // Inatumia picha ya Mwanakwerekwe
  },
];
      ...
      <div className="d-flex flex-grow-1">
        ...
        <main className="flex-grow-1" style={{ backgroundColor: '#f8f9fa' }}>
          ...
          <section
            ...
            style={{
              backgroundImage: `url(${JumbiImage})`, // Tumia picha ya Jumbi kwa background ya hero
