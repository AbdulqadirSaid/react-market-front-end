                ...
                <main className="flex-grow-1 p-4 overflow-auto">
                    <div className="container-fluid">
                        ...
                        <section className="row mb-5 g-4">
                            {/* Kadi ya Wachuuzi - Soko la Jumbi */}
                                ...
                                <div className="card text-white bg-success p-4 shadow-lg border-0 rounded-4 h-100 animate__animated animate__fadeInLeft">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between mb-3">
                                            <h4 className="card-title mb-0 opacity-75"><i className="bi bi-shop me-2"></i>Jumbi Market Vendors</h4>
                                            <i className="bi bi-person-check display-4"></i>
                                        </div>
                                        <p className="card-text fs-1 fw-bold mb-0">{activeVendorsJumbi}</p>
                                        <small className="opacity-75">Active Vendors in Jumbi</small>
                                    </div>
                                </div>
                            </div>

                            {/* Kadi ya Wachuuzi - Soko la Mwanakwerekwe */}
                            <div className="col-lg-6 col-md-12">
                                <div className="card text-white bg-info p-4 shadow-lg border-0 rounded-4 h-100 animate__animated animate__fadeInRight">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between mb-3">
                                            <h4 className="card-title mb-0 opacity-75"><i className="bi bi-shop me-2"></i>Mwanakwerekwe Market Vendors</h4>
                                            <i className="bi bi-person-check display-4"></i>
                                        </div>
                                        <p className="card-text fs-1 fw-bold mb-0">{activeVendorsMwanakwerekwe}</p>
                                        <small className="opacity-75">Active Vendors in Mwanakwerekwe</small>
                                    </div>
                                </div>
                            </div>

                            {/* Kadi ya Bidhaa - Soko la Jumbi */}
                            <div className="col-lg-6 col-md-12">
                                <div className="card text-dark bg-light p-4 shadow-lg border-0 rounded-4 h-100 animate__animated animate__fadeInLeft animate__delay-1s">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between mb-3">
                                            <h4 className="card-title mb-0"><i className="bi bi-box-seam me-2"></i>Jumbi Market Products</h4>
                                            <i className="bi bi-boxes display-4 text-secondary"></i>
                                        </div>
                                        <p className="card-text fs-1 fw-bold mb-0">{productsJumbi}</p>
                                        <small className="text-muted">Total Products in Jumbi</small>
                                    </div>
                                </div>
                            </div>

                            {/* Kadi ya Bidhaa - Soko la Mwanakwerekwe */}
                            <div className="col-lg-6 col-md-12">
                                <div className="card text-white bg-dark p-4 shadow-lg border-0 rounded-4 h-100 animate__animated animate__fadeInRight animate__delay-1s">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between mb-3">
                                            <h4 className="card-title mb-0 opacity-75"><i className="bi bi-box-seam me-2"></i>Mwanakwerekwe Market Products</h4>
                                            <i className="bi bi-boxes display-4"></i>
                                        </div>
                                        <p className="card-text fs-1 fw-bold mb-0">{productsMwanakwerekwe}</p>
                                        <small className="opacity-75">Total Products in Mwanakwerekwe</small>
                                    </div>
                                </div>
                            </div>

                            {/* Kadi ya Maagizo Yanayosubiri - Soko la Jumbi */}
                            <div className="col-lg-6 col-md-12">
                                <div className="card text-white bg-danger p-4 shadow-lg border-0 rounded-4 h-100 animate__animated animate__fadeInLeft animate__delay-2s">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between mb-3">
                                            <h4 className="card-title mb-0 opacity-75"><i className="bi bi-cart-x me-2"></i>Jumbi Pending Orders</h4>
                                            <i className="bi bi-truck display-4"></i>
                                        </div>
                                        <p className="card-text fs-1 fw-bold mb-0">{pendingOrdersJumbi}</p>
                                        <small className="opacity-75">Orders awaiting action in Jumbi</small>
                                    </div>
                                </div>
                            </div>

                            {/* Kadi ya Maagizo Yanayosubiri - Soko la Mwanakwerekwe */}
                            <div className="col-lg-6 col-md-12">
                                <div className="card text-white bg-warning p-4 shadow-lg border-0 rounded-4 h-100 animate__animated animate__fadeInRight animate__delay-2s">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between mb-3">
                                            <h4 className="card-title mb-0 opacity-75"><i className="bi bi-cart-x me-2"></i>Mwanakwerekwe Pending Orders</h4>
                                            <i className="bi bi-truck display-4"></i>
                                        </div>
                                        <p className="card-text fs-1 fw-bold mb-0">{pendingOrdersMwanakwerekwe}</p>
                                        <small className="opacity-75">Orders awaiting action in Mwanakwerekwe</small>
                                    </div>
                                </div>
                            </div>

                            {/* Kadi ya Mapato - Soko la Jumbi */}
                            <div className="col-lg-6 col-md-12">
                                <div className="card text-white bg-primary p-4 shadow-lg border-0 rounded-4 h-100 animate__animated animate__fadeInLeft animate__delay-3s">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between mb-3">
                                            <h4 className="card-title mb-0 opacity-75"><i className="bi bi-cash-stack me-2"></i>Jumbi Monthly Revenue</h4>
                                            <i className="bi bi-currency-dollar display-4"></i>
                                        </div>
                                        <p className="card-text fs-1 fw-bold mb-0">{jumbiRevenueThisMonth}</p>
                                        <small className="opacity-75">Revenue generated in Jumbi this month</small>
                                    </div>
                                </div>
                            </div>

                            {/* Kadi ya Mapato - Soko la Mwanakwerekwe */}
                            <div className="col-lg-6 col-md-12">
                                <div className="card text-white bg-secondary p-4 shadow-lg border-0 rounded-4 h-100 animate__animated animate__fadeInRight animate__delay-3s">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center justify-content-between mb-3">
                                            <h4 className="card-title mb-0 opacity-75"><i className="bi bi-cash-stack me-2"></i>Mwanakwerekwe Monthly Revenue</h4>
                                            <i className="bi bi-currency-dollar display-4"></i>
                                        </div>
                                        <p className="card-text fs-1 fw-bold mb-0">{mwanakwerekweRevenueThisMonth}</p>
                                        <small className="opacity-75">Revenue generated in Mwanakwerekwe this month</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-6 col-md-12">
                                <div className="card bg-gradient-dark text-white p-4 shadow-lg border-0 rounded-4 h-100 animate__animated animate__fadeInUp animate__delay-4s">
                                    <div className="card-body">
