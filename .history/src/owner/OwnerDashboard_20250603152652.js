    ...
    <div className="d-flex flex-column min-vh-100">
      ...
      <div className="d-flex flex-grow-1">
        ...
        <main className="flex-grow-1" style={{ backgroundColor: "#f8f9fa" }}>
          {/* Hero Section: Main Welcome for Market Owners - Changed to deep purple */}
          <section
            // Removed bg-primary class, relying on inline style for custom purple
            className="py-3 text-center text-white position-relative overflow-hidden"
            style={{
              backgroundColor: "#6a0dad", // Deep purple background
              backgroundImage:
                'url("https://via.placeholder.com/1500x300/6a0dad/ffffff?text=Your+Marketplace+Hub")', // Placeholder image matching purple
              ...
              // Changed overlay to a deep purple (rgba)
              boxShadow: "inset 0 0 0 2000px rgba(106, 13, 173, 0.4)", // Deep purple overlay
            }}
          >
