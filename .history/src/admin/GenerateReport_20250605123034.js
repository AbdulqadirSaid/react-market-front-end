...
const GenerateReport = () => {
  ...
  const handleGenerateReport = (e) => {
    ...
    if (reportType === 'market_sales' || reportType === 'market_owner_performance' || reportType === 'product_listings') {
        ...
        <main className="flex-grow-1 overflow-auto p-3" style={{ backgroundColor: "#f8f9fa" }}>
          <div className="container-fluid mt-4">
            <div className="card shadow-lg p-4 bg-white border-0 rounded-4">
              <h2 className="mb-4 text-primary fw-bold"><i className="bi bi-file-earmark-bar-graph me-3"></i>Generate Reports</h2>
              <p className="mb-4 text-muted lead">Select report type, date range, and apply filters to generate various system reports. These reports provide insights into customer activity, market performance, and more.</p>
