    ...
    <div className="d-flex flex-column min-vh-100" style={{ backgroundColor: "#f5f7fa" }}>
      ...
      <div className="d-flex flex-grow-1">
        ...
        <main className="flex-grow-1 overflow-auto p-4" style={{ backgroundColor: "#f8f9fa" }}>
          {/* --- START: UI IMPROVEMENTS FOR REDUCED CONTENT WIDTH --- */}
          {/* Use Bootstrap Container, Row, and Col to center and limit content width */}
          <div className="container"> {/* Use "container" for a fixed max-width, or "container-fluid" if you still want 100% width but with padding */}
            <div className="row justify-content-center"> {/* Centers the column horizontally */}
              <div className="col-lg-10 col-xl-9"> {/* Occupy 10/12 columns on large, 9/12 on extra large screens */}
                <div className="card shadow-lg p-4 bg-white">
                  ...
                  {/* --- START: Closing the UI IMPROVEMENTS divs --- */}
                </div> {/* Closes the card */}
              </div> {/* Closes the col-lg-10 col-xl-9 */}
            </div> {/* Closes the row justify-content-center */}
          </div> {/* Closes the container */}
          {/* --- END: Closing the UI IMPROVEMENTS divs --- */}
        </main>
      </div>
