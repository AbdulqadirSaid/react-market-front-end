const links = {
  ...
  Owner: [
    ...
    { label: "Manage Market Information", path: "/market-info",icon: "dashboard", },
    { label: "Manage Bookings", path: "/manage-bookings", icon: "dashboard" },
    { label: "Manage Reports", path: "/manage-reports", icon: "dashboard" },
    {label: "Manage Payment Information",path: "/payment-info", icon: "dashboard", },
    { label: "Logout", path: "/logout", icon: "dashboard" },
  ],
  ...
  Customer: [
    ...
    { label: "Booking Space", path: "/manage-payment", icon: "dashboard" }
    { label: "Booking Information", path: "/booking-info", icon: "dashboard" },
