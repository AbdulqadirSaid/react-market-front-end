...
import ManageReports from "./owner/ManageReports";
import ManagePaymentInfo from "./owner/ManagePaymentInfo";
...
import BookingSpaces from "./customer/BookingSpace";
...
function App() {
  return (
    ...
    <Routes>
      ...
      <Route path="/payment-info" element={<ManagePaymentInfo/>} />
      ...
      <Route path="/booking-space":marketId element={<BookingSpaces}
