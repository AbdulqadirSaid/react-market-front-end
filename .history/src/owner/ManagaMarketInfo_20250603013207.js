...
import defaultMarketImage from '../images/default-market.jpg'; // Ensure this image exists or use a public URL
...
const ManageMarketInfo = () => {
  ...
  useEffect(() => {
    // Set initial preview image URL when component mounts or selected market changes
  ...
  const handleSave = (e) => {
    ...
    if (newMarketImageFile) {
        const simulatedImageUrl = URL.createObjectURL(newMarketImageFile); // This is temporary, for preview
        setAllMarkets(prevMarkets =>
            prevMarkets.map(market =>
                market.id === selectedMarketId
         ...
         // Clean up the object URL after it's been consumed by `setAllMarkets`
  ...
  return (
    <div className="container-fluid mt-4">
      <div className="card shadow-lg p-4 bg-white">
        ...
        {!isEditing ? (
          <div>
            {/* View Mode: Market Image - Wide, High, Great Visible */}
            <div className="mb-4 text-center">
              <img
                ...
                style={{
                  ...
                  border: '3px solid #007bff' // Great visible border
                }}
              />
          ...
          <form onSubmit={handleSave}>
            {/* Edit Mode: Market Image - Wide, High, Great Visible Preview */}
            <div className="mb-4 text-center">
              <label htmlFor="marketImageUpload" className="form-label d-block text-start mb-2">Market Image Preview</label>
              <img
                src={previewImageUrl || defaultMarketImage}
                alt="Market Preview"
                className="img-fluid rounded shadow-sm border border-light mb-3"
                style={{
                  width: '100%',
                  height: '250px', // Slightly less height in edit mode to make space for file input
                  objectFit: 'cover',
